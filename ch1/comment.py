...
# sep : 문자열 사이 구분자 (기본값은 spacebar)
print('t','e','s','t')  # t e s t  (기본적으로 공백이 들어감)
...
# format : %s(문자열,정수,실수 다 가능), %d(정수), %f(실수)
print("%d" % 100)
print("%5d" % 100)  # 5자리 맞춰서 출력
print("%05d" % 100) # 5자리 맞춰서 출력(자릿수 없는것은 0으로 채우기)
print()
print("%s" % "hi")
print("%5s" % "hi")
print()
print("%-8.2f" % 123.21)    # 숫자 - 자리 쓰면 왼쪽정렬됨 (기본적으로 오른쪽정렬이라)
print("%8.2f" % 123.21)
...
print("%d : %s" % (1, "홍길동"))    #대입되는게 두개이상일 경우 괄호로 묶어야함 
